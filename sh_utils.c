...
/** parse_command - determines d type of cmd
 * @command: command to be parsed
 *
 * Return: constant representing the type of d cmd
 * Description -
 * 		 EXTERNAL_COMMAND (1) repr cmds like /bin/ls
 *		 INTERNAL_COMMAND (2) repr cmds like exit, env
 *		 PATH_COMMAND (3) repr cmds found in the PATH like ls
 *		 INVALID_COMMAND (-1) repr invalid cmds
 */
...
/**
 * get_func - retr a func based on the cmd given and a mapping
